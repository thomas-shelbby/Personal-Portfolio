      ...
      if ($('#contact-form').length > 0) {
         $('#contact-form').validate({
            ...
            messages: {
               ...
               conService: 'Select a service.',
               conMessage: 'Enter your message.',
            },

            submitHandler: function (form) {
               console.log(form) // Logs the full form element

               // Create an object to hold the form data
               const formData = {
                  conName: form.conName.value,
                  conLName: form.conLName.value,
                  conEmail: form.conEmail.value,
                  conPhone: form.conPhone.value,
                  conService: form.conService.value,
                  conMessage: form.conMessage.value,
               }
               ...
               $.ajax({
                  type: 'POST',
                  url: 'https://personal-portfolio-email-js-code.vercel.app/send-email',
